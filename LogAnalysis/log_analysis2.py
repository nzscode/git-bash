...
with open("../VersionControl/error_message2.csv", 'w', newline="") as error_message_csv:
...
with open("../VersionControl/user_statistics2.csv", 'w', newline="") as user_statistics_csv:
